    ...
    public boolean createReflectedImages() {
     ...
     for (int imageId : mImageIds) {
    	 ...
    	 options.inSampleSize=2;
	      Bitmap originalImage = BitmapFactory.decodeResource(mContext.getResources(), imageId,options);
	    ...
	    deafaultPaint.setTextSize(40.0f);  
	    deafaultPaint.setTypeface(Typeface.DEFAULT_BOLD); // 采用默认的宽度  
